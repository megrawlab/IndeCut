...
nsamples_total = int(args[1]) # tota number of generated samples by each algorithm
nsubsamples = int(args[2])    # Number of subsamples 

algDict = {}
algDict["fanmod"] = args[3]
algDict['warswap'] = args[4]
algDict['diamcis'] = args[5]
algDict['comofinder'] = args[6]
...
for method in ['fanmod', 'warswap', 'diamcis', 'comofinder']:
    ...
    file_path_max_ent = args[7]
    CSDP_exec_path = args[8]
    dum_outdir = args[9]
    outdir = args[10]
